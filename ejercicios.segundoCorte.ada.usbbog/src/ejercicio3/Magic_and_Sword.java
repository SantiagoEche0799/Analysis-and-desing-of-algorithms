...
public class Magic_and_Sword {
    ...
    private static void drawRectangulo(int w, int h, int x, int y) {
        rec[0] = x + w;
        rec[1] = x;
        rec[2] = y;
        rec[3] = y + h;
    ...
    private static void drawCirculo(String poder, int level, int x, int y) {
    ...
    private static int respuesta(int w, int h, int x, int y, String poder, int level, int x0, int y0) {
        int dano = dano(poder);
        drawRectangulo(w, h, x, y);
        drawCirculo(poder, level, x0, y0);
        if (confirmarDano()) {
            return dano;
        }
        return 0;
